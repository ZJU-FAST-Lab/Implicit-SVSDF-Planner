...
# news_manager.insertNew("front_end_A_star", "123412314")
# news_manager.insertNew("back_end_minco", "6asfd")
# news_manager.insertNew("swept_volume", "asfdasdfsda")
# news_manager.insertNew("swept_volume2", "asfsadfdsa")
# news_manager.insertNew("swept_volume3", "sdfdasfdas")
# news_manager.insertNew("swept_volume4", "sdfasfdasf")
# news_manager.insertNew("t1", "arzdfdsafasfadsfasfasfsafasfdxcvvsafdfsdasbsfda")
# news_manager.insertNew("astas", "arzdfdsafasfadsfasfasfsafasfdxcvvsafdfsdasbsfda")
# news_manager.insertNew("tasfdasf1", "arzdfdsafasfadsfasfasfsafasfdxcvvsafdfsdasbsfda")
# news_manager.insertNew("asdf", "arzdfdsafasfadsfasfasfsafasfdxcvvsafdfsdasbsfda")
# news_manager.insertNew("t2", "arzdfdsafasfadsfasfasfsafasfdxcvvsafdfsdasbsfda")
# news_manager.insertNew("t2", "arzdfdsafasfadsfasfasfsafasfdxcvvsafdfsdasbsfda")
# news_manager.insertNew("t2", "arzdfdsafasfadsfasfasfsafasfdxcvvsafdfsdasbsfda")
# news_manager.insertNew("t2", "arzdfdsafasfadsfasfasfsafasfdxcvvsafdfsdasbsfda")
# news_manager.insertNew("t2", "arzdfdsafasfadsfasfasfsafasfdxcvvsafdfsdasbsfda")
...
# news_manager.insertNew("t2", "arzdfdsafasfadsfasfasfsafasfdxcvvsafdfsdasbsfda")
# news_manager.insertNew("t2", "arzdfdsafasfadsfasfasfsafasfdxcvvsafdfsdasbsfda")
# news_manager.insertNew("t3","arzdfdsafasfadsfasfasfsafasfdxcvvsafdfsdasbsfda")
# news_manager.insertNew("t1","arzdfdsafasfadsfasfasfsafasfdxcvvsafdfsdasbsfda")
# for i in range(0,100):
#     news_manager.insertNew("yue", "asfddafsdafasdfsdafads")
