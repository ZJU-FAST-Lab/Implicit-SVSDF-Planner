...
public:
                                         ...
                                         Eigen::MatrixX3d &gradC        )
    {
        ...
        Eigen::Vector3d grad_tmp, grad_tmp_p, grad_tmp_a ;
        double thr;
        Eigen::Vector4d quat;
        Eigen::Vector3d omg;
                                          ...
                                          Eigen::MatrixX3d &gradC)
    {
        ...
        for (int i = 0; i < pieceNum; i++)
        {
            ...
            for (int j = 0; j <= integralResolution; j++)
            {
                ...
                obj.flatmap.backward(gradPos, gradVel, 0, gradQuat, gradOmg, gradPosTotal, gradVelTotal, gradAccTotal, gradJerTotal, gradPsiT, gradDPsiT);
